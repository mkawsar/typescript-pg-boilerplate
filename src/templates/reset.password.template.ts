const resetPassword = function (otp: any, firstName: string) {
    const html = `
        <!DOCTYPE html>
        ...
        <div style="display: none;">A request to reset password was received from your ERP Account</div>
                    ...
                    <td align="center" class="sm-px-24" style="font-family: 'Montserrat',Arial,sans-serif;">
                        ...
                        <tr>
                            ...
                            <p style="margin: 0 0 24px;">
                                This is the password reset OTP you requested from ERP. Use to reset your ERP account password.
                            </p>
                            ...
                            <p style="margin: 0 0 16px;">
                                ...
                                <a href="mailto:noreply@erp.com" class="hover-underline"
                                style="--text-opacity: 1; color: #7367f0; text-decoration: none;">noreply@erp.com</a>.
                            </p>
                            </td>
                        </tr>
                        <tr>
    ...
    const text = `Reset Password, You recently requested to reset your password for your ERP account. Copy and paste it for reset password: ${otp} If you did not requested a password reset, please ignore this email or reply to let us know. This password reset is only valid for the next 2 hours.`;
    return {
        html: html,
        text: text,
    };
